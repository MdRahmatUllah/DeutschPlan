...
/// failing Supertonic, a toast says so with a link to Settings
  ...
  switch (outcome) {
    ...
    case TtsOutcome.fellBack:
      DpToast.show(
        ...
        lift: lift,
        actionLabel: l10n.speakerFallbackSettings,
        onAction: () {
          if (context.mounted) context.jumpToTab(const SettingsRoute());
        },
      );
      return true;
