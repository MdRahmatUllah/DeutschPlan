...
/// T2 · swipe to rate — #106. The turned card, `swipe_to_rate` on, held a
/// third of the way to Again: it follows the finger and the rating bar
/// stays, the button equivalent of the swipe.
void main() {
  late AppDatabase db;
  ...
  setUpAll(() async {
    ...
    await settings.write(SettingKeys.swipeToRate, true);
  });
  tearDownAll(() async {
  ...
  goldenTest(
    ...
    act: (tester) async {
      // Held, not let go: the frame is taken mid-swipe.
