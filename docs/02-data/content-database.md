...
| `skill_prompts` | (`level_code`, `ord`), `prompt` | Empty: the workbooks hold no speaking or writing prompts (#294). Kept in the schema for when a real source exists; nothing reads it |
