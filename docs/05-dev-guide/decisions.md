...
| 22 | 2026-09-21 | Glass button radius 14 and sheet radius 26, not the 16/28 in theming.md | The Aurora Glass artboards draw 14 and 26 across every canvas; the artboards are what the screens are diffed against | If the design set changes |
