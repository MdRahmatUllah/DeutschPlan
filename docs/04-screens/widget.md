...
- FR-X1-02 Taps: ring/count → `deutschplan://today`; word → `deutschplan://word/<uid>`; *Pronounce* → same link with `?speak=1` (the app plays on open, every time, whatever is on top: #442).
