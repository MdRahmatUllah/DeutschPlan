...
- **Layout** (FR-W2-04): a 96 dp label column and member columns of 170 dp scroll sideways under the pinned labels on a phone; when every column fits (a tablet), they share the width, the subtitle drops "scroll sideways…" and the "← drag to see …" hint goes. On a phone the hint also goes once the last column has been dragged into view, keeping its room so nothing jumps, and comes back if it is dragged away again (#528).
