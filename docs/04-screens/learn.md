...
**Layout.** Sun header "Your course · 1,248 of 5,593 words · 37 of 182 grammar topics" with a course-wide segmented bar. Level bands (A1 · Anfänger, A2 · Grundstufe, B1 · Mittelstufe, B2, C1, C2) each containing two step tiles: code, badge (*Passed* Lime / *Current* Sun / *Exams unlocked* Lagoon / lock for not started), segmented bar, "540 words · 10 grammar topics". The current tile is expanded: "Today · 8 left" + *Study*, the count T1's button and ring give (its practice sentences too; the artboard's "cards left" left them out, #515), or "Today · all cards done" once no card is open. Below: cards *Grammar library* ("182 topics · 37 learned") and *Word categories* ("Browse by topic across all steps").
