...
## Quiz tab
Tiles *Quick* (10) · *Standard* (20) · *Long* (30) · *Forms* ("Perfekt, 3rd person, plurals from this step") · *Custom* ("Direction, length, source, timer") → custom sheet. Last quiz card: "16 / 20 · Standard · DE → EN · Sun 20 Sep"; the score as L9 shows it, halves kept ("8.5 / 10"), coloured by the unrounded share, and dated by the local day it finished (#335). The badge's score shrinks to fit at large text sizes. Disabled with an explanation until ≥ 10 words of the step are learned.
